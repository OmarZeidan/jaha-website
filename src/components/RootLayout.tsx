  ...
  return (
    <Container>
      <div className="flex items-center justify-between">
        ...
        >
          <Logo className="h-4" invert={invert} filled={logoHovered} />
        </Link>
...
function Navigation() {
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      <NavigationRow>
        <NavigationItem href="/brands">Our Brands</NavigationItem>
